    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6"  style={{background:'white'}}>
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400"  style={{color:'black'}}>Toplam Aktivite</h3>
          <p className="text-3xl font-bold dark:text-white" style={{color:'black'}}>{stats.totalActivities}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6" style={{background:'white'}}>
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400" style={{color:'black'}}>Tamamlanan</h3>
          <p className="text-3xl font-bold dark:text-white" style={{color:'black'}}>{stats.completedActivities}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6" style={{background:'white'}}>
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400" style={{color:'black'}}>Tamamlanma Oranı</h3>
          <p className="text-3xl font-bold dark:text-white" style={{color:'black'}}>{completionRate.toFixed(1)}%</p>
        </div>
      </div>
