...
const mockActivities: Activity[] = [
  {
    ...
    time: "23:00",
    duration: "480",
    description: "Kesintisiz uyku için erken yatış",
    completed: false,
    category: "sleep",
    categoryId: "sleep",
    createdAt: new Date(),
  ...
  },
  {
    ...
    time: "14:00",
    duration: "30",
    description: "Kısa bir dinlenme molası",
    completed: true,
    category: "sleep",
    categoryId: "sleep",
    createdAt: new Date(),
  ...
  {
    id: '3',
    title: "Sabah Erken Kalkış",
    time: "06:00",
    duration: "5",
    description: "Yoğun güne erken başlangıç",
    completed: false,
    category: "sleep",
    categoryId: "sleep",
    createdAt: new Date(),
...
export default function SleepPage() {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm('Bu uyku planını silmek istediğinize emin misiniz?')) {
  ...
  return (
    <div className="min-h-screen pb-20">
      <div className="bg-gradient-blue text-white p-6 rounded-b-3xl shadow-lg mb-8">
        <h1 className="text-3xl font-bold mb-4">Uyku Takibi</h1>
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="relative w-full sm:w-auto flex-1 max-w-md">
            <input
              type="text"
              placeholder="Uyku planı ara..."
              value={searchTerm}
        ...
        {filteredActivities.length > 0 ? (
          ...
          <div className="text-center py-12">
            <div className="bg-slate-100 dark:bg-slate-800 p-8 rounded-2xl max-w-xl mx-auto">
              <h3 className="text-xl font-semibold mb-2">Uyku Planı Bulunamadı</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">Aramanızla eşleşen uyku planı yok veya henüz plan eklenmemiş. Yeni bir uyku planı eklemek ister misiniz?</p>
              <button 
                onClick={() => {
                  setEditingActivity(undefined);
                  setIsModalOpen(true);
