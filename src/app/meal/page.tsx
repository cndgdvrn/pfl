...
const mockActivities: Activity[] = [
  {
    ...
    time: "08:00",
    duration: "30",
    description: "Hafif ve sağlıklı bir kahvaltı",
    completed: true,
    category: "meal",
    categoryId: "meal",
    createdAt: new Date(),
  ...
  },
  {
    ...
    time: "13:00",
    duration: "45",
    description: "Protein ağırlıklı öğle yemeği",
    completed: false,
    category: "meal",
    categoryId: "meal",
    createdAt: new Date(),
  ...
  },
  {
    ...
    time: "19:30",
    duration: "60",
    description: "Hafif akşam yemeği, sebze ağırlıklı",
    completed: false,
    category: "meal",
    categoryId: "meal",
    createdAt: new Date(),
...
export default function MealPage() {
  ...
  return (
    <div className="min-h-screen pb-20">
      <div className="bg-gradient-green text-white p-6 rounded-b-3xl shadow-lg mb-8">
        <h1 className="text-3xl font-bold mb-4">Öğün Takibi</h1>
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            >
              <span className="hidden sm:inline">Yeni Öğün</span>
        ...
        {filteredActivities.length > 0 ? (
            ...
            {filteredActivities.map((activity) => (
              <div 
                ...
                className={`card hover:shadow-lg ${
                  activity.completed ? 'bg-green-50 dark:bg-green-900/20' : ''
                } group transition-all duration-300`}
              >
                <div className="p-6">
                  <div className="flex items-start mb-4">
                    <div className="flex-1">
                      <h3 className="font-semibold text-xl mb-1 group-hover:text-green-600 transition-colors">
                        {activity.title}
                      </h3>
          ...
          <div className="text-center py-12">
            <div className="bg-slate-100 dark:bg-slate-800 p-8 rounded-2xl max-w-xl mx-auto">
              <h3 className="text-xl font-semibold mb-2">Öğün Bulunamadı</h3>
      ...
      <div className="fixed right-6 bottom-6 z-20">
        <button 
          ...
          className="btn-primary h-14 w-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl bg-gradient-green"
        >
